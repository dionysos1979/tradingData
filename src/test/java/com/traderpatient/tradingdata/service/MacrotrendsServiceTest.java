...
public class MacrotrendsServiceTest {

    Logger logger = LoggerFactory.getLogger(MacrotrendsServiceTest.class);

    SimpleDateFormat formatter = new SimpleDateFormat("yyyy-MM-dd", Locale.FRANCE);
    @Autowired
    private MacroTrendsService service;
    ...
    @Test
    public void getHistoricalRevenues() throws ParseException, IOException {
        service.getHistoricalRevenues("TTC");
        logger.info("MacrotrendsServiceTest:OK");
    }
}
