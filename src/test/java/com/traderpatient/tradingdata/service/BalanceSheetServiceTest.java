...
public class BalanceSheetServiceTest {
    ...
    Logger logger = LoggerFactory.getLogger(BalanceSheetServiceTest.class);
    ...
    public void testSaveAllFromAlphaVantage() throws ParseException {
        ...
        logger.info("BalanceSheetService.testSaveAllFromAlphaVantage:" + service.saveAllFromAlphaVantage("PGC").size());
    }
}
