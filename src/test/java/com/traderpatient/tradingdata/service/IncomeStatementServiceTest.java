...
public class IncomeStatementServiceTest {
    ...
    Logger logger = LoggerFactory.getLogger(IncomeStatementServiceTest.class);
    ...
    public void contextLoads() {
        logger.info("BalanceSheetServiceTest.contextLoads()");
    }

    @Test
    public void testSaveAllAnnualFromFMP() throws ParseException {
        service.isCompteurRequetesDepasse(FMPService.SITE_FMP,
                FMPService.API_KEY,
                FMPService.SITE_FMP_MAX_REQ_DAILY);
        logger.info("IncomeStatementService.saveAllAnnualFromFMP:" + service.saveAllAnnualFromFMP("PGC").size());
    }

    @Test
    public void testSaveAllFromAlphaVantage() throws ParseException {
        ...
        logger.info("IncomeStatementService.saveAllFromAlphaVantage:" + service.saveAllFromAlphaVantage("PGC").size());
    }
}
